            ...
            <div className="relative container px-4 mx-auto">
                <div className="max-w-3xl mx-auto">
                    <div className="max-w-xl">
                        ...
                        <Link className="inline-block px-12 py-4 text-lg bg-purple-500 hover:bg-purple-600 text-white font-bold rounded-full transition duration-200" to="/dashboard">Start again</Link>
                    </div>
                </div>
            </div>
        </section>
