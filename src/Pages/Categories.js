...
const Categories = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (form.id) {
            const response = await fetch(`${host}/categories/${form.id}`, {
                method: "PUT",
                headers: headers,
                                                ...
                                                <tr key={category.id}>
                                                    ...
                                                    <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                        <div className="flex gap-2">
                                                            <button className="px-4 py-2 rounded-lg shadow text-white bg-green-400 hover:bg-green-500" onClick={() => handleEdit(category.id)}>
                                                                Edit
                                                            </button>
                                                            <button className="px-4 py-2 rounded-lg shadow text-white bg-red-400 hover:bg-red-500" onClick={() => handleDelete(category.id)}>
                                                                Delete
                                                            </button>
                                                        </div>
                                                    </td>
